...
SECRET_KEY = 'django-insecure-e%rf16(jy5bp77w$!x4hy1kkf5cgki+y@yjnps@w375^!=ejep'
...
WSGI_APPLICATION = 'fjlc.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "templates" / "static",  # React's static folder
]
